...
This project adds **full i18n support to the Hermes Desktop app** with 15 languages. Adding a 9th language requires no code changes — just drop in a new JSON file.
...
本项目为 Hermes 桌面端添加**完整的多语言支持**，覆盖 15 种语言。添加第 15 种语言**零代码改动**——只需放入新的 JSON 文件。
...
- **2026-06-03**: Initial submission with 15 languages, 857 keys each
